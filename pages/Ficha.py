...
if st.button('Buscar Cadastro'):
    ...
    with st.container():
        ...
        **Cartão Nascional de Saúde:** `{resultado.head().iat[0, 3]}` **RG:** `{resultado.head().iat[0, 4]} `
        **CPF:** `{resultado.head().iat[0, 5]}`
        ...
        **Tel:** `{resultado.head().iat[0, 8]}`
        ...
        pdf.cell(180,5, txt=f'Data e hora: {now}',ln=True, align='R')
        ...
        pdf.cell(190,5,txt='',ln=True, border=True)
        pdf.cell(190, 5, txt='', ln=True)
        pdf.cell(190, 5, txt='03 - ANAMNESE:',border=True, ln=True)
        pdf.cell(190, 5, txt='',border=True, ln=True)
        pdf.cell(190, 5, txt='',border=True, ln=True)
        pdf.cell(190, 5, txt='',border=True, ln=True)
        pdf.cell(190, 5, txt='',border=True, ln=True)
        pdf.cell(190, 5, txt='Alergia: (   ) Não (   ) Sim - Qual:',border=True, ln=True)
        pdf.cell(190, 5, txt='', ln=True)
        pdf.cell(190, 5, txt='04 - EXAME FÍSICO:',border=True, ln=True)
        pdf.cell(190, 5, txt='',border=True, ln=True)
        pdf.cell(190, 5, txt='',border=True, ln=True)
        pdf.cell(190, 5, txt='',border=True, ln=True)
        pdf.cell(190, 5, txt='', ln=True)
        pdf.cell(190, 5, txt='05 - EXAMES COMPLEMENTARES SOLICITADOS:',border=True, ln=True)
        pdf.cell(190, 5, txt='(   ) Laboratório - (   ) Radiológico - (   ) ECG - '
                             '(   ) Outros:',border=True, ln=True)
        pdf.cell(190, 5,txt='Hipótese do Diagnóstico:',border=True,ln=True)
        pdf.cell(190, 5, txt='',border=True, ln=True)
        pdf.cell(190, 5, txt='',border=True, ln=True)
        pdf.cell(10, 10,txt='CID:', border=True)
        pdf.cell(20,10,txt='        ',border=True,ln=True)
        pdf.cell(190,5, txt='Conduta: (   ) Medicação - (   ) Observação - (   ) Cross',border=True, ln=True)
        pdf.cell(190,5, txt='Saída: Data/Hora____/____/_______ às _____:______h (   ) Alta Médica - (   ) Evasão - '
                            '(   ) Óbito',border=True,ln=True)
        pdf.cell(190, 5, txt='', ln=True)
        pdf.cell(190, 5, txt='06 - PRESCRIÇÃO MÉDICA:',border=True, ln=True)
        pdf.cell(190, 5, txt='',border=True, ln=True)
        pdf.cell(190, 5, txt='',border=True, ln=True)
        pdf.cell(190, 5, txt='',border=True, ln=True)
        pdf.cell(190, 5, txt='',border=True, ln=True)
        ...
        pdf.image('logo.jpg', 10, 8, 30)
        pdf.image('sus.png', 170, 10, 30)
        pdf.cell(190, 5, txt="PREFEITURA MUNICIPAL DE SANTA BRANCA", ln=True, align='C')
        ...
        pdf.cell(190, 5, txt='SF(0,9%) (   )100ML (   )250ML (   )500ml (   )1000ml', ln=True)
        pdf.cell(190, 5, txt='SG: 5%________ML( ) RINGER ________ML( ) GLICOFISIOLÓGICO: ________ML( )', ln=True)
        pdf.cell(190, 5, txt='Medição:', border=True, ln=True)
        pdf.cell(190, 5, txt='', border=True, ln=True)
        pdf.cell(190, 5, txt='', border=True, ln=True)
        pdf.cell(190, 5, txt='', border=True, ln=True)
        pdf.cell(190, 5, txt='', border=True, ln=True)
        ...
        pdf.cell(190, 5, txt='Telefone: (12) 3972-6620 - E-mail: saude@santabra.sp.gov.br', ln=True, align='C')
